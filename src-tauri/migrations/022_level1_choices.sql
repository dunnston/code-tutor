...
('fork_great_hall', 'path_b_the_fork', 'Proceed through the storage passage to Great Hall (if cleared)', FALSE, NULL, NULL, NULL, 4, '🚪');
...
INSERT OR IGNORE INTO narrative_choices (id, location_id, choice_text, requires_skill_check, skill_type, skill_dc, challenge_action_type, display_order, icon) VALUES
('storage3_to_hall', 'path_b_storage_room3_cleared', 'Proceed through the door to the Great Hall', FALSE, NULL, NULL, NULL, 1, '🚪'),
('storage3_to_fork', 'path_b_storage_room3_cleared', 'Return to the fork to explore other paths', FALSE, NULL, NULL, NULL, 2, '🔙');
