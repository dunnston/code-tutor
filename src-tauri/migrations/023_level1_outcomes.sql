...
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
...
-- Tower Top Actions
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('tower_survey_out', 'tower_top_survey', 'default', 'From here you can see: the trap in Path B (if not yet encountered), a suspicious section of the garden, and a red door in the distance. This knowledge will serve you well.', 'path_a_tower_top_cleared', NULL, NULL, '{"spotted_trap": true, "spotted_greenhouse": true, "spotted_crimson_door": true}', FALSE, NULL, 0),
('tower_descend_out', 'tower_top_descend', 'default', 'You carefully descend back down the tower.', 'path_a_courtyard_cleared', NULL, NULL, NULL, FALSE, NULL, 0);
...
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('storage3_cleared_out', 'storage3_fight', 'success', 'The skeleton crumbles to dust! On the wall, you spot an ancient map showing the fortress layout. This reveals a secret passage you hadn''t noticed!', 'path_b_the_fork', '{"gold": 15, "xp": 30}', NULL, '{"found_fortress_map": true, "storage_cleared": true}', FALSE, NULL, 0);
...
-- Wolf Encounter
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('wolves_calm_success', 'wolves_calm', 'success', 'Your soothing words calm the wolves. They accept you as non-threatening and leave peacefully. Among the remains you find 20 gold and fresh meat!', 'path_c_wild_garden', '{"gold": 20, "items": ["fresh_meat"]}', NULL, '{"wolves_calmed": true}', FALSE, NULL, 0),
...
('wolves_sneak_success', 'wolves_sneak', 'success', 'You move like a shadow, slipping past the wolves undetected. They never notice you!', 'path_c_wild_garden', '{"xp": 10}', NULL, '{"sneaked_past_wolves": true}', FALSE, NULL, 0),
...
-- After wolf combat
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('wolves_defeated_out', 'wolves_attack', 'success', 'The wolves fall! You collect wolf pelts and find 20 gold and fresh meat among the remains.', 'path_c_wild_garden', '{"gold": 20, "xp": 70, "items": ["wolf_pelt", "fresh_meat"]}', NULL, '{"wolves_defeated": true}', FALSE, NULL, 0);
...
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('greenhouse_cleared_out', 'greenhouse_fight', 'success', 'The cube dissolves! Within it you find 30 gold and a random weapon it had absorbed.', 'path_c_greenhouse_cleared', '{"gold": 30, "xp": 50}', NULL, '{"greenhouse_cleared": true}', FALSE, NULL, 0);
...
-- Aqueduct Tunnels
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('aqueduct_north_out', 'aqueduct_north', 'default', 'You climb back up through the well into the courtyard.', 'path_a_courtyard_cleared', NULL, NULL, NULL, FALSE, NULL, 0),
...
('aqueduct_south_fail', 'aqueduct_south', 'failure', 'The rocks are too heavy. You''d need tools or more strength.', 'underground_aqueduct_cleared', NULL, NULL, NULL, FALSE, NULL, 0);
...
-- Level Complete
INSERT INTO narrative_outcomes (id, choice_id, outcome_type, description, next_location_id, rewards, penalties, sets_flags, triggers_combat, enemy_id, enemy_count) VALUES
('complete_descend_out', 'complete_descend', 'default', 'You claim your victory and descend to Level 2, ready for new challenges!', 'level1_start', NULL, NULL, '{"proceeding_to_level2": true}', FALSE, NULL, 0),
