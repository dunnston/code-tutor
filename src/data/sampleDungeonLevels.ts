  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { type: ItemType.POTION, name: 'Health Potion', quantity: 2, description: 'Restores 50 HP' },
        ],
        gold: 75,
        xp: 25,
      },
    ...
    },
    {
      ...
      data: {
        ...
        rewardGold: 200,
        rewardItems: [
          { type: ItemType.WEAPON, name: 'Rusty Short Sword', quantity: 1, description: '+5 Attack' },
        ],
  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { type: ItemType.SCROLL, name: 'Scroll of Fireball', quantity: 1, description: 'Cast Fireball' },
          { type: ItemType.ARMOR, name: 'Enchanted Robes', quantity: 1, description: '+10 Defense' },
        ],
        gold: 500,
        xp: 200,
      },
    },
    {
      ...
      data: {
        ...
        rewardGold: 800,
        rewardItems: [
          { type: ItemType.ARTIFACT, name: 'Phylactery Shard', quantity: 1, description: 'A fragment of dark power' },
        ],
    ...
    },
    {
      ...
      data: {
        ...
        finalRewards: {
          ...
          gold: 300,
          items: [
            { type: ItemType.KEY, name: 'Ancient Key', quantity: 1, description: 'Opens mysterious locks' },
          ],
        },
      },
    },
  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          { type: ItemType.WEAPON, name: 'Dragon Slayer Sword', quantity: 1, description: '+50 Attack vs Dragons' },
          { type: ItemType.ARTIFACT, name: 'Dragon Scale', quantity: 3, description: 'Crafting material' },
        ],
        gold: 5000,
        xp: 1000,
      },
    },
    {
      ...
      data: {
        ...
        rewardGold: 10000,
        rewardItems: [
          { type: ItemType.ARTIFACT, name: 'Heart of the Dragon', quantity: 1, description: 'Ultimate power' },
        ],
    ...
    },
    {
      ...
      data: {
        ...
        finalRewards: {
          ...
          gold: 5000,
          items: [
            { type: ItemType.ARTIFACT, name: 'Dragonbone Crown', quantity: 1, description: 'Proof of your legendary deed' },
          ],
        },
      },
    },
