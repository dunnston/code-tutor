    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          items: [
            { type: ItemType.POTION, name: 'Healing Potion', quantity: 1, description: 'Restores 30 HP' },
            { type: ItemType.KEY, name: 'Brass Key', quantity: 1, description: 'Opens mysterious locks' },
          ],
          gold: 50,
          xp: 25,
        },
      ...
      },
      {
        ...
        data: {
          ...
          items: [{ type: ItemType.POTION, name: 'Healing Herbs', quantity: 2, description: 'Restores 15 HP' }],
          gold: 15,
          xp: 10,
        },
      },
      ...
      },
      {
        ...
        data: {
          ...
          items: [
            { type: ItemType.POTION, name: 'Preserved Food', quantity: 1, description: 'Heals 15 HP' },
            { type: ItemType.WEAPON, name: 'Kitchen Knife', quantity: 1, description: '+2 Attack' },
          ],
          gold: 25,
          xp: 15,
        },
      ...
      },
      {
        ...
        data: {
          ...
          rewardGold: 200,
          rewardItems: [
            { type: ItemType.ARTIFACT, name: 'Glowing Crystal', quantity: 1, description: 'Mysterious power pulses within' },
            { type: ItemType.WEAPON, name: 'Enchanted Sword', quantity: 1, description: '+5 Attack, found within the cube' },
          ],
